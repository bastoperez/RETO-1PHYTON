...
def generar_informe():
    ...
    with open(nombre_archivo, "w", encoding="utf-8") as archivo:
        ...
        for r in registros:
            ...
            if r["analisis"]:
                ...
                if "promedio" in r["analisis"]:
                    archivo.write(f"  - Promedio: {r['analisis']['promedio']:.2f}\n")
                if "maximo" in r["analisis"]:
                    archivo.write(f"  - Valor máximo: {r['analisis']['maximo']}\n")
                if "minimo" in r["analisis"]:
                    archivo.write(f"  - Valor mínimo: {r['analisis']['minimo']}\n")
    ...
    print("📊 Generando gráficos de los experimentos...")
    graficar_resultados()
